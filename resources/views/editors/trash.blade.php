...
<div class="card-deck">
  <div class="card my-4">
    ...
    <div class="card-body">
      ...
      <a href="{{route('realDelete',['id'=>$data->id])}}"" class="btn btn-danger btn-md float-left" onclick="test()">Delete</a>
      <a href="{{route('restore',['id'=>$data->id])}}" class="btn btn-warning btn-md float-right">Restore</a>
    </div>
  </div>
</div>
</div>
